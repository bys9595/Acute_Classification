...
class ResidualMambaEncoder(nn.Module):
    def __init__(self,
                 ...
                 input_channels: int,
                 n_stages: int=6,
                 features_per_stage: Union[int, List[int], Tuple[int, ...]]=[32, 64, 128, 256, 512, 1024],
                 conv_op: Type[_ConvNd]=nn.Conv3d,
                 kernel_sizes: Union[int, List[int], Tuple[int, ...]]=3,
                 strides: Union[int, List[int], Tuple[int, ...], Tuple[Tuple[int, ...], ...]]=2,
...
class UMambaEnc(nn.Module):
    def __init__(self,
                 ...
                 conv_op: Type[_ConvNd]=nn.Conv3d,
                 kernel_sizes: Union[int, List[int], Tuple[int, ...]]=3,
                 strides: Union[int, List[int], Tuple[int, ...]]=2,
